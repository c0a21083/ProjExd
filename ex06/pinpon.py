...
pygame.mixer.init()
sound_reflect = pygame.mixer.Sound("反射.ogg")
sound_explosion = pygame.mixer.Sound("爆発.ogg")
# ボールの動きを計算
...
def main():
    ...
    pygame.draw.circle(circ_sur,(255,165,0),(ball_r, ball_r), ball_r)
    ball = circ_sur
